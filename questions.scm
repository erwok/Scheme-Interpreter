...
(define (enumerateHelper s index)
    (cond ((null? s) '())
          (else (cons (cons index (cons (car s) nil)) (enumerateHelper (cdr s) (+ index 1)))))
    )
...
(define (merge comp list1 list2)
  ...
  (cond ((null? list1) 
        ...
        (else (cond ((comp (car list1) (car list2)) (cons (car list1) (merge comp (cdr list1) list2)))
